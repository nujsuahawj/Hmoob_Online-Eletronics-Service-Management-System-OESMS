...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">OESMS</a>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/Banner1.jpeg);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-danger font-weight-bold">Welcome to OESMS</h1>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      ...
      <p>
        OESMS Services is one of the leading chain of multi-brand Electronics and Electrical service
        workshops offering
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        OESMS Pvt Ltd. <br>
        3 No Tejturi Bazar,<br>
        West, <br>
        Panthapath, <br>
        Dhaka 1215 <br>
        Phone: +8801234567890 <br>
        <a href="#" target="_blank">www.oesms.com</a> <br>

        <br><br>
        <strong>Cumilla Branch:</strong> <br>
        OESMS Pvt Ltd, <br>
        4/1 No Kandirpar,<br>
        Kotwali,Cumilla-3500 <br>
        Phone: +8809876543210 <br>
        <a href="#" target="_blank">www.oesms.com</a> <br>
